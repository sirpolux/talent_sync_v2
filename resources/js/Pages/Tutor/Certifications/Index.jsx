...
export default function Index({ trainer = null, certifications = [], certificationsBySpecialty = {} }) {
    ...
    <TutorLayout headerTitle="Certifications">
      ...
      <div className="mx-auto max-w-6xl space-y-6">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-2 text-sm leading-6 text-white/80">
                Review all certification records, including their linked specialty and uploaded attachments.
              </p>
            </div>
        ...
        <SectionCard
          ...
          description="Certification-first view with related specialty, skill, and attachments."
          emptyState={
